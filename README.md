...
- [Usage](#usage)
  - [Commands overview](#commands-overview)
    - [Sequential export](#sequential-export)
- [License](#license)
...
MXTP processes your audio files through 4 fundamental commands. These commands are executed in a **predefined sequential order**, ensuring a consistent workflow regardless of the order in which they are called.
